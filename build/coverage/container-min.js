...
(function() {
    ...
    YAHOO.extend(o, h, {init: function(v, u) {
            ...
            var v = this.firstElement, y = false;
            if (u && u[1]) {
                t.stopEvent(u[1]);
            }
            if (v) {
            ...
            var v = this.lastElement, y = false;
            if (u && u[1]) {
                t.stopEvent(u[1]);
            }
            if (v) {
            ...
            var A = v[0], x = this.close, u = this.cfg.getProperty("strings"), w;
            if (A) {
                if (!x) {
                    if (!c) {
...
(function() {
    ...
    YAHOO.extend(a, YAHOO.widget.Panel, {form: null, initDefaultConfig: function() {
            ...
            var q = YAHOO.util.Connect, r = this.form, l = false, o = false, s, n, m, j;
            ...
            var o = YAHOO.widget.Button, v = s[0], l = this.innerElement, u, q, k, r, p, j, m;
            d.call(this);
            this._aButtons = null;
            if (f.isArray(v)) {
                ...
                for (m = 0; m < r; m++) {
                    ...
                    if (o) {
                        ...
                        if (f.isFunction(u.handler)) {
                            k.set("onclick", {fn: u.handler, obj: this, scope: this});
                        } else {
                            if (f.isObject(u.handler) && f.isFunction(u.handler.fn)) {
                                k.set("onclick", {fn: u.handler.fn, obj: ((!f.isUndefined(u.handler.obj)) ? u.handler.obj : this), scope: (u.handler.scope || this)});
                            }
                        }
            ...
            var j = this.firstFormElement, m = false;
            if (i && i[1]) {
                b.stopEvent(i[1]);
            ...
            var o = this.cfg.getProperty("buttons"), j = this.lastFormElement, m = false;
            if (i && i[1]) {
                b.stopEvent(i[1]);
            ...
            var o = this.cfg.getProperty("buttons"), l, n, k, j;
            if (o && f.isArray(o)) {
                l = o.length;
                if (l > 0) {
                    j = (l - 1);
            ...
            var m = this.cfg.getProperty("buttons"), k, i, l = false;
            if (m && f.isArray(m)) {
                k = m[0];
                if (k) {
            ...
            var A = this.form, k, t, w, m, u, r, q, j, x, l, y, B, p, C, o, z, v;
            function s(n) {
            ...
            d.call(this);
            this._aButtons = null;
            var j = this.element.getElementsByTagName("form"), k;
            if (j.length > 0) {
                k = j[0];
                if (k) {
                    b.purgeElement(k);
...
(function() {
    ...
    YAHOO.extend(b, YAHOO.widget.Dialog, {initDefaultConfig: function() {
            ...
            var e = this.form.ownerDocument, d = e.createElement("input");
            d.type = "hidden";
            d.name = this.id;
            d.value = "";
